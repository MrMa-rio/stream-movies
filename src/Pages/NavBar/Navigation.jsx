...
export const NavBar = () => {
    ...
    return(
        <div className=" hover:transition-all hover:text-white hover:bg-opacity-50 xl:w-fit small:w-screen super-small:bg-opacity-0 small:bg-opacity-0 relative font-roboto font-semibold bg-slate-700 duration-700 bg-opacity-25 rounded-xl xl:p-10 small:p-2">
            <img className="xl:hover:w-64 hover:transition-all hover:opacity-100 xl:shadow-none shadow-xl duration-700 xl:w-48 opacity-70 rounded-full xl:m-auto" src="../src/assets/imagens/CORNFLIXBR_rect.png" alt="" />
            <nav>
